    ...
    $.getJSON(apiUrl, function (data) {
      var releases = data.map(function (release) {
        return {
          ...
          commitUrl: release.commit.html_url,
      ...
      if (latestRelease) {
        ...
        var releaseHTML = `
          <div class="release-item">
            ...
            <p class="commit-code">Commit Code: <a href="${latestRelease.commitUrl}" target="_blank">${latestRelease.commitUrl}</a></p>
      ...
      olderReleases.forEach(function (release) {
        ...
        var releaseHTML = `
          <div class="release-item">
            <h3 class="release-title">${releaseTitle}</h3>
            <p class="commit-code">Commit Code: <a href="${release.commitUrl}" target="_blank">${release.commitUrl}</a></p>
